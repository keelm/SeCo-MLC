...
/**
 * The seco package implements generic functionality for simple separate-and-conquer rule learning. <pruningDepth> SearchHeuristic
 ...
 * the rule length) <pruningDepth> For more details on rule learning search heuristics and their equivalences, see (F�rnkranz &
 * Flach, ICML-03)
 *
