...
public class TruePositiveRate extends ValueHeuristic {
    ...
    public double evaluateConfusionMatrix(final TwoClassConfusionMatrix confusionMatrix) {
        final double TP = confusionMatrix.getNumberOfTruePositives();
        final double FN = confusionMatrix.getNumberOfFalseNegatives();
